module BNFC.Backend.Scala.RegToJLex (printRegJLex, escapeChar) where

-- modified from pretty-printer generated by the BNF converter
-- Recopied to scala, since we need to extend to JFlex char printing
